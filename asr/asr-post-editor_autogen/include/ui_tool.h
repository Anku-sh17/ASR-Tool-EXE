...
public:
    ...
    void setupUi(QMainWindow *Tool)
    {
        ...
        player_open->setObjectName(QString::fromUtf8("player_open"));
        editor_open = new QAction(Tool);
        editor_open->setObjectName(QString::fromUtf8("editor_open"));
        editor_save = new QAction(Tool);
        editor_save->setObjectName(QString::fromUtf8("editor_save"));
        editor_openTranscript = new QAction(Tool);
        editor_openTranscript->setObjectName(QString::fromUtf8("editor_openTranscript"));
        editor_openTranscript->setCheckable(false);
        editor_openTranscript->setEnabled(true);
        editor_debugBlocks = new QAction(Tool);
        editor_debugBlocks->setObjectName(QString::fromUtf8("editor_debugBlocks"));
        editor_jumpToLine = new QAction(Tool);
        editor_jumpToLine->setObjectName(QString::fromUtf8("editor_jumpToLine"));
        player_togglePlay = new QAction(Tool);
        player_togglePlay->setObjectName(QString::fromUtf8("player_togglePlay"));
        player_togglePlay->setCheckable(false);
        editor_splitLine = new QAction(Tool);
        editor_splitLine->setObjectName(QString::fromUtf8("editor_splitLine"));
        editor_mergeUp = new QAction(Tool);
        editor_mergeUp->setObjectName(QString::fromUtf8("editor_mergeUp"));
        editor_mergeDown = new QAction(Tool);
        editor_mergeDown->setObjectName(QString::fromUtf8("editor_mergeDown"));
        editor_findReplace = new QAction(Tool);
        editor_findReplace->setObjectName(QString::fromUtf8("editor_findReplace"));
        editor_toggleWords = new QAction(Tool);
        editor_toggleWords->setObjectName(QString::fromUtf8("editor_toggleWords"));
        player_seekForward = new QAction(Tool);
        player_seekForward->setObjectName(QString::fromUtf8("player_seekForward"));
        player_seekForward->setCheckable(true);
        player_seekForward->setEnabled(true);
        player_seekBackward = new QAction(Tool);
        player_seekBackward->setObjectName(QString::fromUtf8("player_seekBackward"));
        edit_undo = new QAction(Tool);
        edit_undo->setObjectName(QString::fromUtf8("edit_undo"));
        edit_redo = new QAction(Tool);
        edit_redo->setObjectName(QString::fromUtf8("edit_redo"));
        edit_cut = new QAction(Tool);
        edit_cut->setObjectName(QString::fromUtf8("edit_cut"));
        edit_copy = new QAction(Tool);
        edit_copy->setObjectName(QString::fromUtf8("edit_copy"));
        edit_paste = new QAction(Tool);
        edit_paste->setObjectName(QString::fromUtf8("edit_paste"));
        edit_findReplace = new QAction(Tool);
        edit_findReplace->setObjectName(QString::fromUtf8("edit_findReplace"));
        view_incFont = new QAction(Tool);
        view_incFont->setObjectName(QString::fromUtf8("view_incFont"));
        view_decFont = new QAction(Tool);
        view_decFont->setObjectName(QString::fromUtf8("view_decFont"));
        editor_changeSpeaker = new QAction(Tool);
        editor_changeSpeaker->setObjectName(QString::fromUtf8("editor_changeSpeaker"));
        editor_propagateTime = new QAction(Tool);
        editor_propagateTime->setObjectName(QString::fromUtf8("editor_propagateTime"));
        help_keyboardShortcuts = new QAction(Tool);
        help_keyboardShortcuts->setObjectName(QString::fromUtf8("help_keyboardShortcuts"));
        view_font = new QAction(Tool);
        view_font->setObjectName(QString::fromUtf8("view_font"));
        view_toggleTagList = new QAction(Tool);
        view_toggleTagList->setObjectName(QString::fromUtf8("view_toggleTagList"));
        editor_editTags = new QAction(Tool);
        editor_editTags->setObjectName(QString::fromUtf8("editor_editTags"));
        action_2 = new QAction(Tool);
        action_2->setObjectName(QString::fromUtf8("action_2"));
        editor_saveAs = new QAction(Tool);
        editor_saveAs->setObjectName(QString::fromUtf8("editor_saveAs"));
        editor_close = new QAction(Tool);
        editor_close->setObjectName(QString::fromUtf8("editor_close"));
        editor_changeLang = new QAction(Tool);
        editor_changeLang->setObjectName(QString::fromUtf8("editor_changeLang"));
        editor_autoSave = new QAction(Tool);
        editor_autoSave->setObjectName(QString::fromUtf8("editor_autoSave"));
        editor_autoSave->setCheckable(true);
        Add_Custom_Dictonary = new QAction(Tool);
        Add_Custom_Dictonary->setObjectName(QString::fromUtf8("Add_Custom_Dictonary"));
        Show_Time_Stamps = new QAction(Tool);
        Show_Time_Stamps->setObjectName(QString::fromUtf8("Show_Time_Stamps"));
        Show_Time_Stamps->setCheckable(true);
        Upload_and_generate_Transcript = new QAction(Tool);
        Upload_and_generate_Transcript->setObjectName(QString::fromUtf8("Upload_and_generate_Transcript"));
        Real_Time_Data_Saver = new QAction(Tool);
        Real_Time_Data_Saver->setObjectName(QString::fromUtf8("Real_Time_Data_Saver"));
        Real_Time_Data_Saver->setCheckable(true);
        Save_as_PDF = new QAction(Tool);
        Save_as_PDF->setObjectName(QString::fromUtf8("Save_as_PDF"));
        Open_File_in_Editor1 = new QAction(Tool);
        Open_File_in_Editor1->setObjectName(QString::fromUtf8("Open_File_in_Editor1"));
        Open_File_in_Editor2 = new QAction(Tool);
        Open_File_in_Editor2->setObjectName(QString::fromUtf8("Open_File_in_Editor2"));
        editor_save2 = new QAction(Tool);
        editor_save2->setObjectName(QString::fromUtf8("editor_save2"));
        editor_save3 = new QAction(Tool);
        editor_save3->setObjectName(QString::fromUtf8("editor_save3"));
        move_along_timestamps = new QAction(Tool);
        move_along_timestamps->setObjectName(QString::fromUtf8("move_along_timestamps"));
        move_along_timestamps->setCheckable(true);
        move_along_timestamps->setChecked(false);
        actionShowLineTimeStamp = new QAction(Tool);
        actionShowLineTimeStamp->setObjectName(QString::fromUtf8("actionShowLineTimeStamp"));
        actionShowLineTimeStamp->setCheckable(false);
        actionRemove_Speaker = new QAction(Tool);
        actionRemove_Speaker->setObjectName(QString::fromUtf8("actionRemove_Speaker"));
        actionSave_as_Text = new QAction(Tool);
        actionSave_as_Text->setObjectName(QString::fromUtf8("actionSave_as_Text"));
        actionVoice_Typing = new QAction(Tool);
        actionVoice_Typing->setObjectName(QString::fromUtf8("actionVoice_Typing"));
        ...
        actionVoice_Typing_2->setObjectName(QString::fromUtf8("actionVoice_Typing_2"));
        ...
        add_video->setObjectName(QString::fromUtf8("add_video"));
        ...
        open_transcript->setObjectName(QString::fromUtf8("open_transcript"));
        QIcon icon1;
        ...
        new_transcript->setObjectName(QString::fromUtf8("new_transcript"));
        QIcon icon2;
        ...
        save_transcript->setObjectName(QString::fromUtf8("save_transcript"));
        QIcon icon3;
        ...
        save_as_transcript->setObjectName(QString::fromUtf8("save_as_transcript"));
        QIcon icon4;
        ...
        load_a_custom_dict->setObjectName(QString::fromUtf8("load_a_custom_dict"));
        QIcon icon5;
        ...
        get_PDF->setObjectName(QString::fromUtf8("get_PDF"));
        QIcon icon6;
        ...
        decreseFontSize->setObjectName(QString::fromUtf8("decreseFontSize"));
        QIcon icon7;
        ...
        increaseFontSize->setObjectName(QString::fromUtf8("increaseFontSize"));
        QIcon icon8;
        ...
        toggleWordEditor->setObjectName(QString::fromUtf8("toggleWordEditor"));
        QIcon icon9;
        ...
        keyboard_shortcuts->setObjectName(QString::fromUtf8("keyboard_shortcuts"));
        QIcon icon10;
        ...
        splitter_tool->setObjectName(QString::fromUtf8("splitter_tool"));
        ...
        m_videoWidget->setObjectName(QString::fromUtf8("m_videoWidget"));
        ...
        m_playerControls->setObjectName(QString::fromUtf8("m_playerControls"));
        ...
        splitter_editor->setObjectName(QString::fromUtf8("splitter_editor"));
        splitter_editor->setOrientation(Qt::Vertical);
        m_editor = new Editor(splitter_editor);
        m_editor->setObjectName(QString::fromUtf8("m_editor"));
        splitter_editor->addWidget(m_editor);
        m_wordEditor = new WordEditor(splitter_editor);
        m_wordEditor->setObjectName(QString::fromUtf8("m_wordEditor"));
        ...
        m_tagListDisplay->setObjectName(QString::fromUtf8("m_tagListDisplay"));
        ...
        splitter_editor_2->setObjectName(QString::fromUtf8("splitter_editor_2"));
        splitter_editor_2->setOrientation(Qt::Vertical);
        m_editor_2 = new Editor(splitter_editor_2);
        m_editor_2->setObjectName(QString::fromUtf8("m_editor_2"));
        ...
        m_tagListDisplay_2->setObjectName(QString::fromUtf8("m_tagListDisplay_2"));
        ...
        splitter_editor_3->setObjectName(QString::fromUtf8("splitter_editor_3"));
        splitter_editor_3->setOrientation(Qt::Vertical);
        m_editor_3 = new Editor(splitter_editor_3);
        m_editor_3->setObjectName(QString::fromUtf8("m_editor_3"));
        ...
        m_tagListDisplay_3->setObjectName(QString::fromUtf8("m_tagListDisplay_3"));
